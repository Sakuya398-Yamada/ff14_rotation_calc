...
const WHM_SKILLS = [
  ...
  { id: "glare4", name: "グレアジャ", potency: 640, type: "gcd", icon: "whm/Glare_IV.png", recastTime: GCD_RECAST, animationLock: DEFAULT_ANIMATION_LOCK, resourceChanges: JSON.stringify([{ resourceId: "sacred-sight", amount: -1 }]) },
  ...
  { id: "presence-of-mind", name: "神速魔", potency: 0, type: "ogcd", icon: "whm/Presence_of_Mind.png", recastTime: DEFAULT_ANIMATION_LOCK, animationLock: DEFAULT_ANIMATION_LOCK, buffApplications: JSON.stringify(["presence-of-mind"]), resourceChanges: JSON.stringify([{ resourceId: "sacred-sight", amount: 3 }]) },
];
